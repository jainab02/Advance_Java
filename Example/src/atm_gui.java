...
public class atm_gui extends ConnectDatabase {
						...
						if (Integer.parseInt(amountEntered) > Balance && Integer.parseInt(amountEntered) <= 2000 ) {
							...
							try {
							  ...
							  if (Integer.parseInt(amountEntered) == Balance) {
							      ...
							      screen.append("Thank you for using the application.");
							      ...
							      screen.setText("\n \n Please collect your money \n \n");
							      countCurrency(Integer.parseInt(amountEntered));
							      screen.append("Thank you for using this application.");
							      System.out.println("New Balance: RS " + Balance);
							      InsertCard.setEnabled(true);
							      disableButton();
							      break;
	...
	void CancelOperation()	{
		if (clicked = true) {
			InsertCard.setEnabled(true);
			clicked = false;
			screen.setText("Thank you for using this application.");
			disableButton();
		}
	}
	...
	void checkPin () {
		...
		try {					
			...
			if (UserPin.equals(UserInput)) {
				...
				System.out.println();
				screen.setText("Welcome To this Bank, " + FullName + "\n");
				screen.append("\n");
				optionMessage();
				UserInput = "";
				options();
	...
	// Function for shows a Welcome Message after successful connection
	public void ConnectionMessage() {
		screen.setText("Welcome to Bank Managment System" + "\n");
		screen.append("Please Insert Your Debit Card to Proceed!");
		disableButton();
	...
	public atm_gui() {
		...
		// "Top Label"
		LabelTop =  new JLabel("BANK MANAGEMENT SYSTEM");
//		LabelTop.setBackground(Color.YELLOW);
		...
		LabelTop.setBounds(261, 12, 164, 25);
